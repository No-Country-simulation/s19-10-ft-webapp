...
export default function Landingpage() {
  ...
  return (
    <div className=''>
      <div className="h-screen bg-[url('@/assets/landing-bg.jpg')] flex flex-col justify-between">
        {/* Header */}
        <header className="w-full p-2 flex justify-between items-center bg-slate-50">
        <Link to="/">
          <img src={logo} alt="notepad ai" className="p-4  w-44" />
          </Link>
          <nav className="space-x-4 text-black">
            <Link to="/login" className="bg-blue-600 text-white hover:bg-blue-500 p-3 rounded">
              Sign In
            </Link>
            <Link to="/signup" className="bg-blue-600 text-white hover:bg-blue-500 p-3 rounded">
              Sign up
            </Link>
          </nav>
        </header>
        ...
        <main className="flex flex-col items-center justify-center flex-1 text-center px-5">
          ...
          <Link
            to="/dashboard"
            className="bg-blue-700 hover:bg-blue-500 text-white px-6 py-3 rounded-full text-lg font-medium shadow-md transition duration-300"
          >
            Get Started
          </Link>
        </main>
